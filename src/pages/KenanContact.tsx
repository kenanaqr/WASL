...
interface KenanContactPageProps {
  onNavigate?: (path: string) => void;
}

export const KenanContactPage: React.FC<KenanContactPageProps> = () => {
  ...
  useEffect(() => {
    ...
    document.title = 'Kenan Al Aqrabawi — Co-Founder & CTO | WASL';
  ...
  const handleSaveContact = () => {
    const vCardContent = [
      ...
      'TEL;TYPE=CELL,VOICE;VALUE=uri:tel:+962791071123:+962 79 107 1123',
      'EMAIL;TYPE=WORK,INTERNET:kenanaqr@wasljo.com',
      `URL;TYPE=WORK:${WASL_WEBSITE_URL}`,
      'X-SOCIALPROFILE;TYPE=linkedin:https://www.linkedin.com/in/kenan-aqrabawi-7bb63b273/',
    ...
    link.href = url;
    link.setAttribute('download', 'Kenan-Al-Aqrabawi-WASL.vcf');
  ...
  // Personal contact actions ONLY (WhatsApp, Call, Email, LinkedIn)
  const personalContactActions = [
    {
      id: 'whatsapp',
      label: 'WhatsApp',
      detail: '+962 79 107 1123',
      href: 'https://wa.me/962791071123',
      isExternal: true,
      actionHint: 'Chat',
      icon: (
    ...
    },
    {
      id: 'email',
      label: 'Email',
      detail: 'kenanaqr@wasljo.com',
      href: 'mailto:kenanaqr@wasljo.com',
      isExternal: false,
      actionHint: 'Send',
      icon: (
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      id: 'linkedin',
      label: 'LinkedIn',
      detail: 'Kenan Al Aqrabawi',
      href: 'https://www.linkedin.com/in/kenan-aqrabawi-7bb63b273/',
      isExternal: true,
      actionHint: 'Connect',
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.46 8.76a1.47 1.47 0 0 0 1.47-1.47 1.47 1.47 0 0 0-1.47-1.47 1.47 1.47 0 0 0-1.47 1.47c0 .81.66 1.47 1.47 1.47m1.37 9.74v-8.37H5.09v8.37h2.74z" />
        </svg>
      ),
    },
  ];
          ...
          <div className="space-y-2.5">
            ...
            <div className="pt-1">
              <button
                ...
                aria-label="Save Kenan Al Aqrabawi contact to phone"
              >
                {saved ? (
                  <>
